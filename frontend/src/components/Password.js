      ...
      <div id="passwordDiv">
        ...
        <Container>
            ...
            <Row>
                ...
                <Form>
                    <Form.Group className="mb-3" controlId="formBasicVerificationPassword">
                    <Form.Label>Enter New Password:</Form.Label>
                    <Form.Control type="text" placeholder="password" ref={(c) => password = c}/>
                    </Form.Group>
                </Form>

                <Button onClick={doPassword}>Reset Password</Button> <Link to="/" className="btn btn-outline-primary">Login</Link>
                </Col>
                <Col></Col>
            </Row>
        </Container>
