...
function Verification()
{
    ...
    const doVerification = async event => 
    {
        ...
        var obj = {verifyEmail:json_id.verifyEmail,email:json_id.email,code:code.value};
        var js = JSON.stringify(obj);
        try
        {    
            const response = await fetch(buildPath('api/verifyCode'),{method:'POST',body:js,headers:{'Content-Type': 'application/json'}});
        ...
        <Container>
            ...
            <Row>
                ...
                <Form>
                    ...
                    <Form.Control type="code" placeholder="12345" ref={(c) => code = c}/>
                    </Form.Group>
                </Form>

                <Button onClick={doVerification}>Submit</Button> <Link to="/register" className="btn btn-outline-primary">Register</Link>
                </Col>
                <Col></Col>
            </Row>
        </Container>
